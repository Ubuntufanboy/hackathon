...
while 1:
    ...
    if zval > 100 and check:
        cv2.putText(img,"move back",(120,70), cv2.FONT_HERSHEY_PLAIN, 3, (255,0,255), 3)
    elif zval < 80 and check:
        cv2.putText(img,"Move Closer",(120,70), cv2.FONT_HERSHEY_PLAIN, 3, (255,0,255), 3)
    else:
        cv2.putText(img,"Hold",(120,70), cv2.FONT_HERSHEY_PLAIN, 3, (255,0,255), 3)
        check = False
